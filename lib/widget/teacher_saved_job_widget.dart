...
class TeacherSavedJobWidget extends StatefulWidget {
  const TeacherSavedJobWidget({super.key});

  @override
  State<TeacherSavedJobWidget> createState() => _TeacherSavedJobWidgetState();
}

class _TeacherSavedJobWidgetState extends State<TeacherSavedJobWidget> {
  @override
