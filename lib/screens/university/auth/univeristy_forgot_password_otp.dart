...
class UniveristyForgotPasswordOtp extends StatefulWidget {
  const UniveristyForgotPasswordOtp({super.key});

  @override
  State<UniveristyForgotPasswordOtp> createState() =>
      _UniveristyForgotPasswordOtpState();
}

class _UniveristyForgotPasswordOtpState
    extends State<UniveristyForgotPasswordOtp> {
  String enteredOtp = '';
